...
export const SkeletonBlock: React.FC<ISkeletonBlockProps> = ({itemsCount, width, height}) => {
...
const SkeletonItem: React.FC<{width: number, height: number}> = ({width, height}): JSX.Element => {
    return <div
