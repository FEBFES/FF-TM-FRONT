...
export const LogoIcon: React.FC<LogoIconProps> = ({ isDark }): JSX.Element => {
	return (
		<>
			{isDark ? (
				<svg
					...
					<path
						...
						strokeWidth="4"
					/>
					<path d="M4.66699 2V17.8427" stroke="#CECECE" strokeWidth="4" />
					<path d="M15.333 25.3145V10.2285" stroke="#CECECE" strokeWidth="4" />
					<path
